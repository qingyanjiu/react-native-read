...
module.exports = _reactNative2.default.createClass({
  ...
  updateIndex: function updateIndex(offset, dir) {
    ...
    if(Math.ceil(diff / step)<0)
      // index = index + Math.ceil(diff / step);
      index = index - 1;
    else if(Math.ceil(diff / step)>0)
      index = index + 1;
  ...
  scrollTo: function scrollTo(index) {
    ...
    var x = 0;
    var y = 0;
    if (state.dir == 'x') x = Math.ceil(diff) * state.width;
    if (state.dir == 'y') y = Math.ceil(diff) * state.height;
