          ...
          <View style={styles.modal}>
            <View style={{flexDirection:'row',justifyContent:'center',alignItems:'center'}}>
              <View style={styles.inputs}>
                <TextInput style={{paddingLeft:20}} placeholder={'请输入书名'} textAlign={'center'} onChangeText={(text) => this.setState({text:text})} value={this.state.text} autoFocus={true}> 
                </TextInput>
              </View>
        ...
        //扫描成功后的书籍展示框
          ...
          <View style={styles.slide0}>
            <View style={{height: 100,flexDirection:'row',justifyContent:'flex-start',alignItems:'center',marginTop:20}}>
              <Image style={{height:100,width:76}} source={{uri: this.state.scanedBook.images.large}}> 
              </Image>
              <View style={{flexDirection:'column',alignItems:'flex-start',justifyContent:'center',marginLeft:20}}>
                <Text style={{width:screenWidth/2,fontSize:20,paddingBottom:6,flexWrap:'wrap'}}>{this.state.scanedBook.title}</Text> 
                <Text style={{width:screenWidth/2,fontSize:12,paddingBottom:6,flexWrap:'wrap'}}>{this.state.scanedBook.author}</Text>
       ...
       <View style={{flex:1}}>
        ...
        <View style={ styles.header }>
          ...
          <TouchableOpacity onPress={()=>{this.setState({modalVisible:true,modalType:'1'});}}>
            <View style={[styles.inputs,{marginBottom:6,width:160,height:32,borderRadius:16,flexDirection:'row',justifyContent:'center',alignItems:'center',borderWidth:2,borderColor:'rgba(255,255,255,1)'}]} textAlign={'center'} onChangeText={(text) => this.setState({text:text})} value={this.state.text}> 
